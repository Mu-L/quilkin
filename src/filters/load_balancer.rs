...
//! Distributes packets received downstream among all upstream endpoints.
//!
//! #### Filter name
//! ```text
...
//! ```
//!
//! The load balancing policy (the strategy to use to select what endpoint to
//! send traffic to) is configurable.  In the example above, packets will be
//! distributed by selecting endpoints in turn, in round robin fashion.
//!
//! ### Metrics
//!
