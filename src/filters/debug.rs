...
//! Logs all incoming and outgoing packets to standard output.
//!
//! This filter is useful in debugging deployments where the packets strictly
//! contain valid `UTF-8` encoded strings. A generic error message is instead
//! logged if conversion from bytes to `UTF-8` fails.
//!
//! #### Filter name
//! ```text
