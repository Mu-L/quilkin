...
//! Finds and captures a series of bytes within a packet.
//!
//! Finds and captures bytes within a packet into
//! [`super::metadata::CAPTURED_BYTES`], so that it can be utilised by filters
//! further down the chain.
//!
//! This is often used as a way of retrieving authentication tokens from a
//! packet, and used in combination with [`super::concatenate_bytes`] and
//! [`super::token_router`] filter to provide common packet routing utilities.
//!
//! #### Filter name
//! ```text
